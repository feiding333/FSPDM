...
// sigma2
//Construct the objective function with the sigma2 as the only input by wrapping objfunc() function.
double MainAlgorithm::objfunc_with_sigma2(double matter_){
  set_sigma2( matter_);
  return objfunc();
}
